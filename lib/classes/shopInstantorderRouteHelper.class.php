...
class shopInstantorderRouteHelper {
    ...
    public static function getRouteTemplates($route_hash = null, $template_id = null) {
        ...
        if ($template_id) {
            ...
            $templates = array();
            foreach (shopInstantorderPlugin::$templates as $template_id => $template) {
    ...
    protected static function getRouteTemplate($route_hash = null, $template_id, $read = true) {
        if (empty(shopInstantorderPlugin::$templates[$template_id])) {
            return false;
        }
        if ($route_hash === null) {
            $route_hash = self::getCurrentRouteHash();
        ...
        $template = shopInstantorderPlugin::$templates[$template_id];
    ...
    public static function getRouteSettings($route = null, $setting = null) {
        ...
        $routes = wa()->getPlugin('instantorder')->getSettings('routes');
